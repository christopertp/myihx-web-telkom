...
describe('src/components/fields/Autocomplete', () => {
  ...
  test('onClickItem, onBlur, onChange, & onFocus', () => {
    ...
    result.props.children[1].props.onBlur();
    result.props.children[1].props.onChange({ target: { value: 'targetValue' } });
    ...
    result.props.children[1].props.onFocus();
    ...
    result2.props.children[1].props.onBlur();
